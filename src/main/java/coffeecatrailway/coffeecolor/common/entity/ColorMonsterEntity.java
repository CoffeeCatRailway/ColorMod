package coffeecatrailway.coffeecolor.common.entity;
...
public class ColorMonsterEntity extends MonsterEntity {
    ...
    private static final Map<DyeColor, float[]> DYE_RGB = Maps.newEnumMap(Arrays.stream(DyeColor.values()).collect(Collectors.toMap((DyeColor dye) -> dye, ColorMonsterEntity::createRGBColor)));
    ...
    public static float[] createRGBColor(DyeColor dye) {
