...
import coffeecatrailway.coffeecolor.common.item.crafting.ColorRingRecipe;
...
public class ColorRecipes {
    ...
    public static final RegistryObject<SpecialRecipeSerializer<ColorRingRecipe>> COLOR_RING_SERIALIZER = RECIPE_SERIALIZERS.register("color_ring", () -> new SpecialRecipeSerializer<>(ColorRingRecipe::new));
}
